...
const App = () => {
  ...
  if (!notes.length) {
    ...
    return (
      <main id="app">
        <header className="notes__header"><h2>{activeNav}</h2></header>
      </main>
    );
  }
  return (
    <main id="app">
      <BrowserRouter>
        <Routes>
            ...
            <Route path="/create-note"  element={<><Nav /><CreateNote setNotes={setNotes}/></>}/>
            <Route path="/edit-note/:id"  element={<><Nav /><EditNote notes={notes} setNotes={setNotes}/></>}/>
